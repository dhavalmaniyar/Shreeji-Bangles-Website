...
<html lang="en">
    ...
    <body>
        ...
        <h3 style=" text-align: center;margin: 10px 0;"><strong>Yearly Collection</strong></h3>
        <section class="row justify-content-center" id="row1">
            <div class="col-md-8" style="background-color: black;">
                <div class="row" style="border: 1px solid white;">
                    ...
                    <div class="col">
                        <h4><i class="fa fa-calendar"> Year</i></h4>
                    </div>
                    <div class="col">
            ...
            <sql:query dataSource="${con}" var="result" sql="select year(date)as year,sum(collection)as collection from dailycollection group by year(date)" ></sql:query>
